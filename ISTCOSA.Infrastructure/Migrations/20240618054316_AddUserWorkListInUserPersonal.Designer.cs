...
namespace ISTCOSA.Infrastructure.Migrations
{
    ...
    [Migration("20240618054316_AddUserWorkListInUserPersonal")]
    partial class AddUserWorkListInUserPersonal
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ISTCOSA.Domain.Entities.UserWork", b =>
                {
                    ...
                    b.HasOne("ISTCOSA.Domain.Entities.UserPersonalInformation", null)
                        .WithMany("UserWork")
